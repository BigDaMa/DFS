...
from fastsklearnfeature.declarative_automl.optuna_package.myautoml.utils_model import optimize_accuracy_under_constraints_weights
...
for test_holdout_dataset_id in test_holdout_dataset_ids:
    ...
    for minutes_to_search in range(1, 6):
        ...
        for repeat in range(5):
            ...
            study_prune.optimize(lambda trial: optimize_accuracy_under_constraints_weights(trial=trial,
            ...
            best_model_weight = 0
            if 'model_weight' in study_prune.best_trial.params:
                best_model_weight = study_prune.best_trial.params['model_weight']
            best_number_trials = study_prune.best_trial.params['number_trials']
