...
for test_holdout_dataset_id in test_holdout_dataset_ids:
    ...
    for training_time in [0.01, 0.05, 0.1, 1.0, 10.0]:
        ...
        pickle.dump(results_dict, open('/home/felix/phd2/picture_progress/all_test_datasets/all_results_training_time_constraint.p', 'wb+'))
