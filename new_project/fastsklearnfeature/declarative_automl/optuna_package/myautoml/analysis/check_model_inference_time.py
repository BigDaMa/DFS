...
for test_holdout_dataset_id in test_holdout_dataset_ids:
    ...
    for inference_time in [0.00074, 0.00078, 0.00085, 0.00143, 0.00261, 0.00664]:
        ...
        pickle.dump(results_dict, open('/home/felix/phd2/picture_progress/all_test_datasets/all_results_inference_time_constraint.p', 'wb+'))
