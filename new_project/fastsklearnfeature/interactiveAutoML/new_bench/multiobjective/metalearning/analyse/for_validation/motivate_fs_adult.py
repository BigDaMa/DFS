...
for efolder in experiment_folders:
	...
	for rfolder in run_folders:
		try:
			...
			#if info_dict['dataset_id'] == '1590' and info_dict['constraint_set_list']['model'] == 'Logistic Regression':
			if info_dict['dataset_id'] == '1590' and info_dict['constraint_set_list']['model'] == 'Decision Tree':
			#if info_dict['dataset_id'] == '1590' and info_dict['constraint_set_list']['model'] == 'Gaussian Naive Bayes':
...
for i in range(len(datapoints)):
	my_latex += '(' + str(datapoints[i,0]) + ',' + str(datapoints[i,1]) + ')'
