...
while True:
	...
	X_train, X_validation, X_train_val, X_test, y_train, y_validation, y_train_val, y_test, names, sensitive_ids, key, sensitive_attribute_id = get_fair_data1_validation('31')
	...
	def objective(hps):
		...
		try:
			...
			acc_constraint = hps['accuracy']
			if acc_constraint > 1.0:
				acc_constraint = 1.0

			feature_list.append(acc_constraint)
			...
			feature_list.append(cv_acc - acc_constraint)
