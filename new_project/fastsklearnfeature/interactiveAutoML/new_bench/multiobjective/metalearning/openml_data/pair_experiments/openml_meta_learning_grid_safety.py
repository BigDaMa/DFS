...
for min_accuracy in [0.5, 0.53, 0.56, 0.59, 0.62, 0.65, 0.68]:
	for min_robustness in [0.5,  0.55, 0.6,  0.65, 0.7,  0.75, 0.8,  0.85, 0.9,  0.95, 1.0]:
		...
		with open('/tmp/current_heat_map_safety_acc.txt', 'w+') as f:
		...
		if np.sum(success_per_strategy) == 0:
			...
			results_heatmap[(min_accuracy,min_robustness)] = (time_per_strategy[fastest_strategy_id] / float(success_per_strategy[fastest_strategy_id]), fastest_strategy_id)
